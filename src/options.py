...
# * Literal["ClassesPreview", "HorizontalGrid", "SideAnnotationsGrid", "Poster", "HorizontalGridAnimated"]
...
CLASSES_PREVIEW_PADDINGS: dict = {"top": "10%", "bottom": "10%", "left": "150px", "right": "150px"}
