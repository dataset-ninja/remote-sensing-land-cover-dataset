**LoveDA: A Remote Sensing Land-Cover Dataset for Domain Adaptive Semantic Segmentation** is a dataset for semantic segmentation tasks. It is used in the satellite industry.
